                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      {imageDimensions && showDimensionTooltip && (
                        <div className="absolute top-2 left-2 bg-black bg-opacity-80 text-white px-4 py-2 rounded-lg shadow-xl z-10 animate-fade-in">
                          <div className="flex items-center gap-2">
                      ...
                      <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-200 rounded-lg pointer-events-none"></div>
                    </div>
                  </div>
                )}
              </div>
