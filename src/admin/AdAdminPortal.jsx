// src/components/AdAdminPortal.jsx
      ...
      {showModal && (
        ...
        >
          <form 
            ...
            className="relative w-full max-w-3xl max-h-[90vh] bg-white rounded-2xl shadow-2xl flex flex-col border border-gray-100 overflow-hidden animate-in fade-in duration-200"
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              {adType === 'single' ? (
                <div className="space-y-6">
                  ...
                  {/* Toggle button check */}
                  <div className="flex items-center justify-between bg-blue-50/30 p-4 rounded-xl border border-blue-50">
                  ...
                  {/* Button Details */}
                  {formData.has_button && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200 animate-in slide-in-from-top-2 duration-200">
                    ...
                    {slides.map((slide, index) => (
                      <div key={slide.id} className="p-5 border border-gray-200 rounded-2xl bg-white space-y-4 shadow-sm hover:shadow-md transition-shadow relative">
                        ...
                        <div className="space-y-3 pt-2">
                          ...
                          {slide.has_button && (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200 shadow-inner animate-in slide-in-from-top-1 duration-200">
                              <div className="space-y-1">
                                ...
                                <input
                                  ...
                                  disabled={submitting}
                                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:outline-none bg-white"
                                />
                              </div>
                              <div className="space-y-1">
                                <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-wider">
